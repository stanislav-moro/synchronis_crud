...
let virtual-env = "D:\С рабочего стола\Программирование\Питон\Проекты\synchronis_crud"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\С рабочего стола\Программирование\Питон\Проекты\synchronis_crud\Scripts\deactivate.nu"
